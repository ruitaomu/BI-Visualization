  ...
  <section class="panel">
    ...
    <div class="panel-body">
			<form id="profile" method="post" class="form-horizontal" action="{href}" autocomplete="off" data-frwk-validation="user_model::default" data-frwk-submitfn="save" data-frwk-mode="upd">
				...
				<div class="control-group form-group">
				  <label for="password" class="control-label col-lg-2 col-md-2 col-sm-2">{'New Password'|i18n}</label>
					<div class="controls col-lg-10 col-md-10 col-sm-10">
						<input type="password" id="password" name="password" class="form-control" maxlength="32" placeholder="New Password">
					</div>
				</div>
				<div class="control-group form-group">
				  <label for="password_retype" class="control-label col-lg-2 col-md-2 col-sm-2">{'Retype New Password'|i18n}</label>
					<div class="controls col-lg-10 col-md-10 col-sm-10">
